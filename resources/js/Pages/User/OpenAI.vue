            ...
            <div class="sm:px-4 lg:px-8 mt-5 md:col-span-2 md:mt-0">
                <form @submit.prevent="form.post(route('user.openai.post'))">
                    <div class="flex flex-col px-4">
                        ...
                        <div v-if="image">
                            <img class="h-72 w-auto" :src="image.data[0].url" alt="" @click="openPhotoModal"></div>
                        <div>
                        ...
                        <div>
                            <label for="prompt" class="block text-m font-bold text-white pt-8"> Describe what you want to see here!</label>
                            <div class="mt-1">
